...
function App() {
  return (
    <main className="bg-blue-800 min-h-screen">
      <Nav />
      <div className="flex flex-col 2xl:flex-row py-16 px-8 sm:p-16 xl:px-32 2xl:p-32 gap-24 2xl:gap-32">
          ...
          <div className="bg-blue-900 p-6 sm:p-8 flex flex-col gap-4 rounded-xl">
            ...
            <div className="flex flex-row gap-4 items-center">
              ...
              <div className="flex flex-row gap-2 items-center">
                ...
                <p className="text-blue-200 font-semibold text-xs">AP Calculus Teacher</p>
              </div>
              <div className="hidden sm:flex flex-row gap-1 text-yellow-500 font-bold items-center text-sm">
